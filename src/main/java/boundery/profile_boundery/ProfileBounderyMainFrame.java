...
public class ProfileBounderyMainFrame extends JFrame {

    //MainFrame components
    DashBoard dashBoard = new DashBoard();
    ProfileBounderyCentralPannel centralPanel = new ProfileBounderyCentralPannel();
    JPanel southPannel = new JPanel();
    JPanel eastPannel = new JPanel();
    JPanel westPannel = new JPanel();

    public ProfileBounderyMainFrame(){
        super("Unishare");
